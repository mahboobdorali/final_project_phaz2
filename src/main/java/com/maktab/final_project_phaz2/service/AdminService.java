...
public class AdminService {
    ...
    public void addExpertToUnderService(String underServiceName) throws NoResultException {
    ...
    public void addUnderServiceByAdmin(String underServiceName) throws NoResultException {
        UnderService underService = serviceUnderService.underServiceByName(underServiceName);
